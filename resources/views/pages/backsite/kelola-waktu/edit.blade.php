...
@section('title', 'Edit Kelola Waktu')
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card mb-4">
            ...
            <hr class="my-0" />
            <div class="card-body">
              <form id="formAccountSettings" method="POST" action="/kelola-waktu/{{ $time->id }}">
                @method('put')
                @csrf
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control @error('waktu_mulai') is-invalid @enderror" type="time" id="waktu_mulai" name="waktu_mulai" value="{{ old('waktu_mulai', $time->waktu_mulai) }}" placeholder="California" />
                    @error('waktu_mulai')
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control @error('waktu_akhir') is-invalid @enderror" type="time" id="waktu_akhir" name="waktu_akhir" value="{{ old('waktu_akhir', $time->waktu_akhir) }}" placeholder="California" />
                    @error('waktu_akhir')
                    <div class="invalid-feedback"> {{ $message }}</div>
                    @enderror
                  </div>
                  <div class="mb-3 col-md-6">
                    ...
                    <select id="is_available" name="is_available" class="select2 form-select">
                        <option value="0"  {{ old('is_available', $time->is_available) == "0" ? ' selected' : '' }}>False</option>
                        <option value="1"  {{ old('is_available', $time->is_available) == "1" ? ' selected' : '' }}>True</option>
                      </select>
                  </div>
                <div class="mt-2">
